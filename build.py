...
if platform.system() == "Darwin":
    shutil.copyfile(os.path.join(".", "models", "About Custom Models.txt"),
                    os.path.join(release_archive_path, "About Custom Models.txt"))
    shutil.make_archive(release_archive_path, "zip", release_archive_path)
else:
    os.mkdir(os.path.join(release_archive_path, "models"))
    shutil.copyfile(os.path.join(".", "models", "About Custom Models.txt"),
                    os.path.join(release_archive_path, "models", "About Custom Models.txt"))
